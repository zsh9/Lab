...
public class RecommmendAdapter extends RecyclerView.Adapter<RecommmendAdapter.ViewHolder> {
    private List<Apply> list = new ArrayList<>();
    private Context context;

    public RecommmendAdapter(Context context, List<Apply> typeList) {
    ...
    @Override
    public RecommmendAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_recomend, parent, false);
        return new RecommmendAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RecommmendAdapter.ViewHolder holder, int position) {
